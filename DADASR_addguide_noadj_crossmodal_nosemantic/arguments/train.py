...
parser.add_argument('--cross-modal-fusion', dest='use_cross_modal_fusion', action='store_true', default=False, help='Fuse explicit RGB--LR DSM local similarity and joint-statistics gates before refinement')
